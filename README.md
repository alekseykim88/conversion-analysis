...
причины просадки:
1. возможные баги при покупке товаров из корзины
2. неудобный UX (сложно перейти к оплате)
3. снижение целевой аудитории
4. Ожидание скидок и акций
5. влиаяние внешних факторов (сезонность, каникулы и т.д.)
